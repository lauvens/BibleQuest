...
export default function LeconPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={loadLesson} className="text-sm font-medium text-primary-600 dark:text-primary-400 hover:underline">
            Réessayer
          </button>
        </div>
      </div>
  ...
  if (loading || !lessonData || questions.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <p className="text-gray-500 dark:text-gray-400">{loading ? "Chargement..." : "Aucune question trouvée."}</p>
      </div>
    );
  }
